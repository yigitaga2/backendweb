<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">{{ __('This will be used in your public profile URL.') }}</p>
        </div>
        ...
        <div>
            ...
            <textarea id="about_me" name="about_me" rows="4" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Tell us a bit about yourself and your reading interests...">{{ old('about_me', $user->about_me) }}</textarea>
        ...
        <div>
            ...
            @if($user->profile_photo)
                <div class="mt-2">
                    <img src="{{ $user->profile_photo_url }}" alt="Current profile photo" class="w-20 h-20 rounded-full object-cover">
