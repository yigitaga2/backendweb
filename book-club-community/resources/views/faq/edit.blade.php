        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('faq.update', $faq) }}" class="space-y-6">
                        @csrf
                        @method('PATCH')
                        ...
                        <div>
                            ...
                            <x-text-input id="question" name="question" type="text" class="mt-1 block w-full" :value="old('question', $faq->question)" required autofocus placeholder="What question do users frequently ask?" />
                        ...
                        <div>
                            ...
                            <textarea id="answer" name="answer" rows="8" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required placeholder="Provide a clear and helpful answer...">{{ old('answer', $faq->answer) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="is_published" name="is_published" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <option value="0" {{ old('is_published', $faq->is_published) == '0' ? 'selected' : '' }}>📝 Draft</option>
                                    <option value="1" {{ old('is_published', $faq->is_published) == '1' ? 'selected' : '' }}>✅ Published</option>
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="sort_order" name="sort_order" type="number" min="0" class="mt-1 block w-full" :value="old('sort_order', $faq->sort_order)" />
